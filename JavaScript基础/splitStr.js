// let arrs = []
// let str = '001003004021023002'
// for (let i = 0, len = str.length; i < len; i = i + 3) {
//     arrs.push(str.substring(i, i + 3))
// }
...
// let a = [1, 2, 3, 4].reduce((prev, cur) => {
//     return cur + prev
// })

// console.log('a', str.split(/^\d{3}$/))
...
// let dd = a1.filter(e => b1.includes(e))
// console.log('dd', dd);
...
<business comment="未开票据查询" id="WKPJCX">
<body>
...
console.log(xotree.parseXML(xml));